...
const ProfilesAdminPage = async () => {
  ...
  return (
    <>
      ...
      />
      {/*
        The two ids are the sidebar's scroll targets. FR-193 names workspaces and execution profiles
        as two of the six admin surfaces, and they ship on one screen — so the nav lists both and
        the fragment decides which half of it the operator lands on.
      */}
      <div id="execution-profiles">
        <ProfilesPanel />
      </div>
      <div id="workspaces">
        <WorkspacesPanel />
